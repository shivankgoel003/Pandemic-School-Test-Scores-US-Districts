#### Preamble ####
# Purpose: Cleans the data for learning model and test scores for 11 US states
# Author: Navya Hooda, Shivank Goel, Vanshika Vanshika
# Date: 07 February 2024
# Contact: shivankg.goel@mail.utoronto.ca,vanshika.vanshika@mail.utoronto.ca
# License: MIT
...
#reading data
statescoredata = read_dta("inputs/data/state_score_data.dta")
#schooling mode data
schoolmode = read_dta("inputs/data/schooling_mode_data.dta")
#Colorado
colorado = read_excel("inputs/data/learningmodel/Colorado_Districts_LearningModelData_Final.xlsx")
#Connecticut
connecticut = read_excel("inputs/data/learningmodel/Connecticut_Districts_LearningModelData_Final.xlsx")
#Massachusets
massachusets = read_excel("inputs/data/learningmodel/Massachusetts_Districts_LearningModelData_Final.xlsx")
#Minnesota
minnesota = read_excel("inputs/data/learningmodel/Minnesota_Districts_LearningModelData_Final.xlsx")
#Mississippi
mississippi = read_excel("inputs/data/learningmodel/Mississippi_Schools_LearningModelData_Final.xlsx")
#Ohio
ohio = read_excel("inputs/data/learningmodel/Ohio_Districts_LearningModelData_Final.xlsx")
#Rhode Island
rhode = read_excel("inputs/data/learningmodel/RhodeIsland_Schools_LearningModelData_Final.xlsx")
#Virginia
virginia = read_excel("inputs/data/learningmodel/Virginia_Districts_LearningModelData_Final.xlsx")
#West Virginia
westvirginia = read_excel("inputs/data/learningmodel/WestVirginia_Districts_LearningModelData_Final.xlsx")
#Winscosin
winscosin = read_excel("inputs/data/learningmodel/Wisconsin_Schools_LearningModelData_Final.xlsx")
#Wyoming
wyoming = read_excel("inputs/data/learningmodel/Wyoming_Districts_LearningModelData_Final.xlsx")
...
learning_model_files <- c(
  "inputs/data/household/Household Pulse Survey_02-11-2024 (1).csv",
  "inputs/data/household/Household Pulse Survey_02-11-2024 (2).csv",
  "inputs/data/household/Household Pulse Survey_02-11-2024 (3).csv",
  "inputs/data/household/Household Pulse Survey_02-11-2024 (4).csv",
  "inputs/data/household/Household Pulse Survey_02-11-2024 (5).csv",
  "inputs/data/household/Household Pulse Survey_02-11-2024 (6).csv",
  "inputs/data/household/Household Pulse Survey_02-11-2024 (7).csv",
  "inputs/data/household/Household Pulse Survey_02-11-2024 (8).csv",
  "inputs/data/household/Household Pulse Survey_02-11-2024 (9).csv",
  "inputs/data/household/Household Pulse Survey_02-11-2024 (10).csv",
  "inputs/data/household/Household Pulse Survey_02-11-2024 (11).csv"
)
...
cleaned_state_scoredata = read.csv("inputs/data/cleaned_state_scoredata.csv")
